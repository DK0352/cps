...
```
To avoid updateing the last access time on files during reading operation use --no-access-time or -a
```
cps -a /home/user/Documents/dir1 /home/user/Documents/dir2
```
